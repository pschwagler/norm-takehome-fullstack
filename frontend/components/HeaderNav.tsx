...
export default function HeaderNav({
  ...
  const helpColor = isHelpHovered ? BRAND_PURPLE : NEUTRAL_GRAY;
  ...
  return (
    ...
    >
      <Flex justifyContent="flex-start" width="full" alignItems="center">
        ...
        <Box height="32px" width="1px" bg={BORDER} mx={3} />
        <Text
          fontSize="md"
          userSelect="none"
          fontWeight="bold"
      ...
      <HStack>
        <Flex alignItems={'center'}>
          <Menu>
            ...
            <MenuList bg="white" borderColor={BORDER} zIndex={100}>
              <MenuItem
                color={TEXT_PRIMARY}
                _hover={{ bg: HOVER_PURPLE, color: BRAND_PURPLE }}
                _focus={{ bg: HOVER_PURPLE, color: BRAND_PURPLE }}
                _active={{ bg: HOVER_PURPLE, color: BRAND_PURPLE }}
                onClick={signOut}
              >
                <Box
                  paddingRight="8px"
